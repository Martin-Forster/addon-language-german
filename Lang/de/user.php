...
return array(
    ...
    "unverified"                    => "Nicht Verifziert",
    "unverified_email_desc"         => "Benutzer hat nicht den Besitz der Email Addresse verifiziert.",
    "unverified_account"            => "Bitte prüfen sie Ihre Nachrichten um sich zu verifzieren.",
    ...
    "send_verification_email"       => "Sende Verifizierungs Email",
    "mark_as_verified"              => "Markiere als verifiziert",
    "password_reset_already"        => "Sie haben bereits den Besitz dieser Email Adresse bestätigt, fahren sie mit dem Login fort.",
    "verification_email_resent"     => "Eine neue Verifizierungnachricht wurde gesendet, und sollte bald eintreffen.",
    "verified_set_password_desc"    => "Vielen dank für das Verifizieren der Email Addresse, bitte geben sie unten Ihr gewünschtes Passwort ein.",
    "thank_you_for_verifying_email" => "Vielen dank für das Verifizieren der Email Addresse.",
    ...
    "resend_verification_email"     => "Erneutes senden der Verifizierungs Nachricht",
    ...
    "email_verification"            => "Email Verifikation",
    "email_verification_already_in_use" => "Diese Email Addresse wird bereits benutzt.",
    "verification_link_expired"     => "Der Verifizierungslink ist abgelaufen. Wenn Ihr Link nciht funktioniert, fordern sie einen neuen an.",
    "user_invited_to_organisation"  => "Der Benutzer wurde via Email in die Organisiation eingeladen, Der Benutzer muss auf den Link clicken und sich ein Passwort setzen.",
    "invite_user"                   => "Benutzer einladen",
    "organisation_invite_user"      => "Benutzer zur Organisation einladen",
    "user_already_in_organisation"  => "Benutzer ist bereits Teil der Organisation.",
    "invitations"                   => "Einladung|Einladungen",
    "invite_exists"                 => "Der Benutzer ist bereits eingeladen.",
    "success_join"                  => "Sie sind jetzt Mitglied der Organisation :name.",
    "error_join"                    => "Der Einladungs Code wurde nicht gefunden oder ist abgelaufen.",
    "verify_to_view_tickets"        => "Bitte verifizieren sie alle zusätzlichen Email Addressen oder löschen sie nicht verifizierte Addressen von Ihrem Konto.",
